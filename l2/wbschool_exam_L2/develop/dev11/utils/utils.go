...
import (
	"encoding/json"
	"errors"
	"github.com/azdaev/wb-internship/l2/wbschool_exam_L2/develop/dev11/calendar"
	"net/http"
	"strconv"
	"time"
)
...
// ParseCreateRequest reads x-www-form-urlencoded and parses time and name. Returns Event object
